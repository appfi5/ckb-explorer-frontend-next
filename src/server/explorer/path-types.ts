...
export type APITypeTuple = {
  ...
  "GET /udt_hourly_statistics": [null, Array<APIExplorer.UdtDailyStatisticsResponse>],
  ...
  "GET /daily_statistics/{indicator}": [{ indicator: string }, Array<APIExplorer.DailyStatisticResponse>],
