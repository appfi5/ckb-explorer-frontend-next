...
// import type { Dob } from "../DobsService";
import type { UDT } from "@/models/UDT";
...
export type SupportedExportTransactionType =
...
export type RGBCells = Record<string, { data: Response.Wrapper<LiveCell, "cell_output"> }[]>;
...
export interface NervosDaoInfo {
  totalDeposit: string;
