      ...
      <div className={styles.content}>
        <div className={styles.endContent}>
          ...
          <div className={styles.endContentWrapper}>
            ...
            <div className={styles.description}>
              Withdraw your assets via Godwoken Bridge and Force Bridge before
              the deadline.
            </div>
            <a
        ...
        <div className={styles.exitContent}>
          ...
          <div className={styles.neonText}>
            E<span className={styles.neonTextFade}>X</span>I
            <span className={styles.neonTextFade}>T</span>
          </div>
