...
const useOption = (
  ...
  return {
    color: chartThemeColor.totalSupplyColors,
    tooltip: !isThumbnail
      ? {
        confine: true,
        trigger: 'axis',
    ...
    series: [
      {
        ...
        stack: 'sum',
        areaStyle: {
          color: chartThemeColor.totalSupplyColors[0],
        },
        encode: {
          x: 'timestamp',
          y: 'circulating',
      ...
      },
      {
        ...
        stack: 'sum',
        areaStyle: {
          color: chartThemeColor.totalSupplyColors[1],
        },
        encode: {
          x: 'timestamp',
          y: 'locked',
      ...
      },
      {
        ...
        stack: 'sum',
        areaStyle: {
          color: chartThemeColor.totalSupplyColors[2],
        },
        encode: {
          x: 'timestamp',
          y: 'burnt',
...
export const TotalSupplyChart = ({ isThumbnail = false }: { isThumbnail?: boolean }) => {
  ...
  return (
    <SmartChartPage
      ...
      fetchData={(() => server.explorer("GET /daily_statistics/{indicator}", { indicator: "circulating_supply-burnt-locked_capacity", limit: selectedRange })) as any}
