...
export const PresetPageSizes = [10, 20, 50, 100];
...
export const ListPresetPageSizes = [25, 50, 75, 100];
...
export const ChartColor = {
  ...
  daoColors: ["#5700FF", "#00CC9B", "#484E4E"],
...
// export const GITHUB_ISSUE_URL = "https://github.com/Magickbase/ckb-explorer-public-issues/issues";
