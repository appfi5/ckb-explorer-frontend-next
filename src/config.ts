...
//   BITCOIN_EXPLORER:
//     process.env.REACT_APP_BITCOIN_EXPLORER || "https://mempool.space",
//   PROB_NODE:
//     process.env.REACT_APP_PROB_NODE || "https://api-nodes.magickbase.com",
//   DID_INDEXER_URL: process.env.REACT_APP_DID_INDEXER_URL?.split(",") || [
...
//   REACT_APP_SSRI_RPC_URL:
//     process.env.REACT_APP_SSRI_RPC_URL || "https://ssri.magickbase.com/",
// };
