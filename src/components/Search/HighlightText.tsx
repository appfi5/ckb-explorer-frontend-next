...
export const HighlightText: FC<HighlightTextProps> = ({
  ...
  useEffect(() => {
    ...
    const calculatePart = (
      leftTruncationIndex: number,
      rightTruncationIndex: number,
      maxKeywordWidth: number,
    ) => {
      if (keywordIndex === -1) {
    ...
    let { left, right, highlight } = calculatePart(
      leftTruncationIndex,
      rightTruncationIndex,
      maxKeywordWidth,
    );
    ...
    if (currentWidth < wrapperWidth) {
      ...
      do {
        ...
        ({ left, right, highlight } = calculatePart(
          leftTruncationIndex,
          rightTruncationIndex,
          maxKeywordWidth,
        ));
