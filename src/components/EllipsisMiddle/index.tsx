...
>(
  (
    ...
    useEffect(() => {
      ...
      const rightPart = remainingChars.splice(
        remainingChars.length - minEndLen,
        minEndLen,
      );
      let currentWidth = measureText(
        [leftPart, ellipsis, rightPart].flat().join(""),
      );
      ...
      if (currentWidth > width) {
        ...
        while (true) {
          const char = nextDirectionIsLeft
